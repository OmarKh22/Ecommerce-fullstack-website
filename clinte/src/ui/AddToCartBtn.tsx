...
//   }, [product, cartProduct]);
  ...
  const newClassName = twMerge(
    "bg-[#f7f7f7] uppercase text-xs py-3 text-center rounded-full font-semibold hover:bg-darkText hover:text-whiteText hover:scale-105 duration-200 cursor-pointer",
    className
  );
      ...
      {existingProduct ? (
        <div className="flex self-center items-center justify-center gap-2">
          <button
            ...
            className="bg-[#f7f7f7] text-darkText p-2 border-[1px] border-gray-200 hover:border-skyText rounded-full text-sm hover:bg-white duration-200 cursor-pointer"
          >
            <FaMinus />
          </button>
